...
* [25+ well-documented, coupled in logical groups methods](https://github.com/pawelWritesCode/godog-example-setup/blob/main/main_test.go#L78) useful for testing HTTP(s) API,
